...
const wordList = createWordList(Table_Words);
  ...
  overlay.innerHTML = `
    <div class="modal">
      ...
      <div class="modal-buttons">
        <button class="pos" data-action="place">Разместить</button>
        <button class="neg" data-action="cancel">Отмена</button>
      </div>
    </div>
  `;
...
async function exportToPDF() {
  ...
  doc.save('3rd_Vite-CrossWord.pdf');
}
